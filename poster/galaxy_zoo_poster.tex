...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   We evaluate features by comparing rmse on the best hyper-parameter setting of Random Forest Regression. We use 5-fold CV and hold number of trees in the forest fixed to 100. The figure below shows RMSE for HoG and Raw Pixel based features. Clearly, raw pixel based features are much better than HoG features. 
	...
	To understand why raw pixel based features perform better, we look at the feature importance score calculated across different decision trees in the forest. The feature importance score is calculated using how many sample point prediction it influences. Intuitively, if a feature is more close to the root, more predictions it influence, so more is it's importance weight. The heat-map above shows HoG feature importance, figure below shows heat-map for each channel of $9 \times 9$ image and sum of feature importance values. Intuitively, raw pixels have higher number of regions as important features. Also, they have active features in the edges which can identify artifacts, and spiral edges better than HoG features.
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  To compare random forest regression against baseline, we train multi task lasso regression with raw pixel based features. The plot below shows 5-fold CV rmse for different settings of $\alpha (regularization coefficient)$. At best $\alpha=0.01$, the rmse is $18.8\%$, which is worse compared to rmse for random forest regression $(17.486\%)$. Finally, we train on the full training set and our best test set rmse=$17.366\%$ corresponds to raw pixel based features using random forest regression.
  \begin{center}
  \includegraphics[width=0.2\linewidth]{lasso_cv.png}
  \end{center}
}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   subsection of the image and small translation of this informative area could cause large shift in model output. 
   ...
   \end{center}
   The graph above shows rmse on 5-fold CV  for random forest regression with 100 trees.
   }
\end{poster}%
%
\end{document}
